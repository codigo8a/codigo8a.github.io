...
const TIPS = {
  es: [
    ...
    "Usa el buscador (Search) para encontrar archivos por nombre o contenido.",
    ...
    "El Explorador de Archivos muestra tus documentos en una cuadrícula de iconos estilo Windows 98.",
    ...
    "Prueba diferentes wallpapers, o pon tu propia imagen de fondo desde Configuración → Escritorio.",
    "Clippy tiene 25 tips diferentes que aparecen en orden aleatorio.",
    ...
    "📂 El Portafolio está disponible en el menú Start y escritorio. Explora proyectos, sistemas y tutoriales.",
    "🖼️ Haz clic en las imágenes del visor markdown para verlas en grande con flechas de navegación.",
    "🔗 Comparte cualquier documento con el botón Compartir en la barra del visor.",
  ],
  en: [
    ...
    "Use the search (Search) to locate files by name or content.",
    ...
    "File Explorer displays your documents in an icon grid styled like Windows 98.",
    ...
    "Try different wallpapers, or set your own background picture from Settings → Desktop.",
    "Clippy has 25 different tips that appear in random order.",
    ...
    "📂 The Portfolio is available from the Start Menu and desktop. Explore projects, systems and tutorials.",
    "🖼️ Click on images in the markdown viewer to open a full-screen gallery with navigation arrows.",
    "🔗 Share any document using the Share button in the markdown viewer toolbar.",
  ]
};
